            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              />
                <button
                  ...
                  className="absolute top-1/2 right-0 -translate-y-1/2 flex h-full items-center justify-center px-3 text-gray-500 hover:text-gray-700 focus:outline-none min-w-[2.5rem]"
